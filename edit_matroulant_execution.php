	...
	if (isset($_POST['submit'])) {
        ...
        if(empty($code) || empty($nom) || empty($puissance) || empty($marque) || empty($nbjour) || empty($locationjour) || empty($conso_car_jour) || empty($prix_carburant) || empty($conso_lub_jour) || empty($prix_lubrifiant)) 
		     ...
		     $error = "Veuillez saisir des nombres pour le nombre de jour, la location par jour et les differents prix.";
		         ...
		         $_SESSION['edited_matroulant_execution'] = 'Materiel roulant modifié!';
		 
		         header('Location: liste_matroulant_execution.php?idp='.$idp.'&idde='.$idde);
             }	 
...
?>
    ...
    <center>
	     ...
	     <?php
                    if(isset($_GET['idp']) && !empty($_GET['idp']) && is_projet_exist(htmlspecialchars($_GET['idp'])) == true && isset($_GET['idde']) && !empty($_GET['idde']) && isset($_GET['idroulant']) && !empty($_GET['idroulant'])) {
          ...
          ?>
			  ...
			  <h4>Modification materiel roulant <span style="color: #08c;"><?php echo $roulant['nom_matroulant_execution']; ?></span></h4>
 ...
 <center>
      ...
      <div class="" style="background-color:#6DCCF4; margin-top: 20px; width: 600px; border: 2px solid black; border-radius: 4px;">
          ...
          <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'].'?idp='.$id.'&idde='.$idde.'&idroulant='.$idroulant; ?>" method="post" enctype="multipart/form-data" id="" style="padding-top: 50px;">
		                                
              <div class="control-group">
			  
               <label class="control-label">Code materiel:</label>
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="code_materiel_roulant" id="code_materiel_roulant" value="<?php if($code) echo $code; else echo $roulant['code_matroulant_execution']; ?>" placeholder="Entrez le code du materiel roulant">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="nom_materiel_roulant" id="nom_materiel_roulant" value="<?php if($nom) echo $nom;  else echo $roulant['nom_matroulant_execution']; ?>" placeholder="Entrez le nom de l'engins">
		 ...
		 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="puissance_materiel_roulant" id="puissance_materiel_roulant" value="<?php if($puissance) echo $puissance;  else echo $roulant['puissance_matroulant_execution']; ?>" placeholder="Entrez la puissance du materiel roulant">
			 ...
			 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="marque_materiel_roulant" id="marque_materiel_roulant" value="<?php if($marque) echo $marque;  else echo $roulant['marque_matroulant_execution']; ?>" placeholder="Entrez la marque du materiel roulant">
			 ...
			 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="jour_materiel_roulant" id="jour_materiel_roulant" value="<?php if($nbjour) echo $nbjour;   else echo $roulant['nombre_jour_matroulant_execution']; ?>" placeholder="Entrez le nombre de jours du matériel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="location_materiel_roulant" id="location_materiel_roulant" value="<?php if($locationjour) echo $locationjour;   else echo $roulant['location_par_jour_matroulant_execution'];  ?>" placeholder="Entrez le montant de la location par jours de materiel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="carburant_materiel_roulant" id="carburant_materiel_roulant" value="<?php if($conso_car_jour) echo $conso_car_jour;   else echo $roulant['consommation_carburant_par_jour_matroulant_execution']; ?>" placeholder="Entrez la consommation de carburant par Jour du matériel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="prix_carburant_materiel_roulant" id="prix_carburant_materiel_roulant" value="<?php if($prix_carburant) echo $prix_carburant;   else echo $roulant['prix_carburant_matroulant_execution'];  ?>" placeholder="Entrez le prix du carburant du materiel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="lubrifiant_materiel_roulant" id="lubrifiant_materiel_roulant" value="<?php if($conso_lub_jour) echo $conso_lub_jour;  else echo $roulant['consommation_lubrifiant_par_jour_matroulant_execution']; ?>" placeholder="Entrez la consommation de lubrifiant par Jour du materiel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="prix_lubrifiant_materiel_roulant" id="prix_lubrifiant_materiel_roulant" value="<?php if($prix_lubrifiant) echo $prix_lubrifiant;   else echo $roulant['prix_lubrifiant_matroulant_execution'];  ?>" placeholder="Entrez le prix du lubrifiant du materiel roulant">
		    ...
		    <span id="champ_cacheee">
			      ...
			      <a href="liste_matroulant_execution.php?idp=<?php echo $id.'&idde='.$idde; ?>">
	  ...
	  <?php 
		...
		<p>
		  ...
		  &nbsp;<a href="liste_matroulant_prevision.php?idp=<?php echo $projet['id_projet'].'&idde='.$idde; ?>"><button style="margin-top: 20px;" class="btn btn-primary btn-mini" type="button">Liste materiel roulant execution <i class="icon icon-arrow-right icon-white"></i>  </button></a>
