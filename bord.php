		...
		<div>
         ...
         <div>
                 ...
                 ?>
                  ...
                  ?>
				  <?php $count_ops = count(listOpByRubAndByPro($rubrique['rubrique_name'], $idp)); ?>
                  <div style="width: 20%; margin-left: 0px; margin-bottom: 10px; margin-top: 50px;">
				      <h4>
					      <span  style="background-color: <?php echo randomColor2(); ?>;"><?php echo $rubrique['rubrique_name']; ?></span><br/>
				           (<?php if($count_ops == 1) echo $count_ops.' operation'; else if($count_ops > 1) echo $count_ops.' operations';?>)
				       </h4>
				    </div>
                    ...
                    <div style="background-color: ; width: 70%; margin-left: 100px;"  class="panel panel-default">
                         ...
                         <table class="table table-bordered table-hover" border="1 solid #ccc">
						     ...
						     <tbody class="tbody">
							  ...
							  <td><?php echo $op['operation_mode_pay']; ?></td>
                              <td><?php echo $op['operation_formated_montant']; ?></td>
							   ...
							   <?php if ($op === end($ops)) $flag = 1; ?>
							       ...
							       <?php if($flag == 1) { ?>
								       <tr>
									       <td colspan="4" ><center><em><h5>TOTAL</em></h5></center></td>
