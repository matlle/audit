	...
	if (isset($_POST['submit'])) {
        ...
        if(empty($code) || empty($nom) || empty($puissance) || empty($marque) || empty($nbjour) || empty($locationjour) || empty($conso_car_jour) || empty($prix_carburant) || empty($conso_lub_jour) || empty($prix_lubrifiant)) 
		     ...
		     $error = "Veuillez saisir des nombres pour le nombre de jour, la location par jour et les differents prix.";
				 ...
				 editEnginExecution($code, $nom, $puissance, $marque, $nbjour, $locationjour, $conso_car_jour, $prix_carburant, $conso_lub_jour, $prix_lubrifiant, $idde, $ideng, $cid);

		         $_SESSION['edited_engin_execution'] = 'Engin modifié!';
...
?>
    ...
    <center>
	     ...
	     <?php
                    if(isset($_GET['idp']) && !empty($_GET['idp']) && is_projet_exist(htmlspecialchars($_GET['idp'])) == true && isset($_GET['idde']) && !empty($_GET['idde'])  && isset($_GET['ideng']) && !empty($_GET['ideng'])) {
          ...
          ?>
			  ...
			  <h4>Modification engin <span style="color: #08c;"><?php echo $engin['nom_engin_execution']; ?></span></h4>
  ...
  <center>
      ...
      <div class="" style="background-color:#6DCCF4; margin-top: 20px; width: 600px; border: 2px solid black; border-radius: 4px;">
          ...
          <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'].'?idp='.$id.'&idde='.$idde.'&ideng='.$ideng; ?>" method="post" enctype="multipart/form-data" id="" style="padding-top: 50px;">
		                                
              <div class="control-group">
			  
               <label class="control-label">Code engins:</label>
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="code_engins" id="code_engins" value="<?php if($code) echo $code; else echo $engin['code_engin_execution']; ?>" placeholder="Entrez le code de l'engins du personnel">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="nom_engins" id="nom_engins" value="<?php if($nom) echo $nom; else echo $engin['nom_engin_execution']; ?>" placeholder="Entrez le nom de l'engins">
		 ...
		 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="puissance_engins" id="puissance_engins" value="<?php if($puissance) echo $puissance; else echo $engin['puissance_engin_execution']; ?>" placeholder="Entrez la puissance de l'engins">
			 ...
			 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="marque_engins" id="marque_engins" value="<?php if($marque) echo $marque; else echo $engin['marque_engin_execution']; ?>" placeholder="Entrez la marque de l'engins">
			 ...
			 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="jour_engins" id="jour_engins" value="<?php if($nbjour) echo $nbjour; else echo $engin['nombre_jour_engin_execution']; ?>" placeholder="Entrez le nombre de jours de l'engins">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="location_engins" id="location_engins" value="<?php if($locationjour) echo $locationjour; else echo $engin['location_par_jour_engin_execution']; ?>" placeholder="Entrez le montant de la location par jours de l'engins">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="carburant_engins" id="carburant_engins" value="<?php if($conso_car_jour) echo $conso_car_jour; else echo $engin['consommation_carburant_par_jour_engin_execution']; ?>" placeholder="Entrez la consommation de carburant par Jour de l'engins">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="prix_carburant" id="prix_carburant" value="<?php if($prix_carburant) echo $prix_carburant; else echo $engin['prix_carburant_engin_execution']; ?>" placeholder="Entrez le prix du carburant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="lubrifiant_engins" id="lubrifiant_engins" value="<?php if($conso_lub_jour) echo $conso_lub_jour; else echo $engin['consommation_lubrifiant_par_jour_engin_execution']; ?>" placeholder="Entrez la consommation de lubrifiant par Jour de l'engins">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="prix_lubrifiant" id="prix_lubrifiant" value="<?php if($prix_lubrifiant) echo $prix_lubrifiant; else echo $engin['prix_lubrifiant_engin_execution']; ?>" placeholder="Entrez le prix du lubrifiant">
		     ...
		     <span id="champ_cacheee">
			      ...
			      <a href="liste_engin_execution.php?idp=<?php echo $id.'&idde='.$idde; ?>">
