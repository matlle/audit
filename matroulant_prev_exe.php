	...
	if (isset($_POST['submit'])) {
        ...
        if(empty($code) || empty($nom) || empty($puissance) || empty($marque) || empty($nbjour) || empty($locationjour) || empty($conso_car_jour) || empty($prix_carburant) || empty($conso_lub_jour) || empty($prix_lubrifiant)) 
		     ...
		     $error = "Veuillez saisir des nombres pour le nombre de jour, la location par jour et les differents prix.";
			     ...
			     enregistrer_matroulant_execution($code, $nom, $puissance, $marque, $nbjour, $locationjour, $conso_car_jour, $prix_carburant, $conso_lub_jour, $prix_lubrifiant, $idde, $_SESSION['login']);

		         $_SESSION['saved_matroulant_execution'] = 'Nouveau engin enregistré!';
...
?>
 ...
 <center>
      ...
      <div class="" style="background-color:#6DCCF4; margin-top: 20px; width: 600px; border: 2px solid black; border-radius: 4px;">
		        ...
		        <u><h5>Création d'un materiel roulant</h5></u>
          ...
          <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'].'?idp='.$id.'&idde='.$idde; ?>" method="post" enctype="multipart/form-data" id="" style="padding-top: 50px;">
              ...
              <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="code_materiel_roulant" id="code_materiel_roulant" value="<?php if($code) echo $code; ?>" placeholder="Entrez le code du materiel roulant">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="nom_materiel_roulant" id="nom_materiel_roulant" value="<?php if($nom) echo $nom; ?>" placeholder="Entrez le nom de l'engins">
		 ...
		 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="puissance_materiel_roulant" id="puissance_materiel_roulant" value="<?php if($puissance) echo $puissance; ?>" placeholder="Entrez la puissance du materiel roulant">
			 ...
			 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="marque_materiel_roulant" id="marque_materiel_roulant" value="<?php if($marque) echo $marque; ?>" placeholder="Entrez la marque du materiel roulant">
			 ...
			 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="jour_materiel_roulant" id="jour_materiel_roulant" value="<?php if($nbjour) echo $nbjour; ?>" placeholder="Entrez le nombre de jours du matériel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="location_materiel_roulant" id="location_materiel_roulant" value="<?php if($locationjour) echo $locationjour; ?>" placeholder="Entrez le montant de la location par jours de materiel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="carburant_materiel_roulant" id="carburant_materiel_roulant" value="<?php if($conso_car_jour) echo $conso_car_jour; ?>" placeholder="Entrez la consommation de carburant par Jour du matériel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="prix_carburant_materiel_roulant" id="prix_carburant_materiel_roulant" value="<?php if($prix_carburant) echo $prix_carburant; ?>" placeholder="Entrez le prix du carburant du materiel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="lubrifiant_materiel_roulant" id="lubrifiant_materiel_roulant" value="<?php if($conso_lub_jour) echo $conso_lub_jour; ?>" placeholder="Entrez la consommation de lubrifiant par Jour du materiel roulant">
	 ...
	 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="prix_lubrifiant_materiel_roulant" id="prix_lubrifiant_materiel_roulant" value="<?php if($prix_lubrifiant) echo $prix_lubrifiant; ?>" placeholder="Entrez le prix du lubrifiant du materiel roulant">
	  ...
	  <?php 
		...
		<p>
			 ...
			 <?php
                    if(isset($_GET['idp']) && !empty($_GET['idp']) && is_projet_exist(htmlspecialchars($_GET['idp'])) == true  && isset($_GET['idde']) && !empty($_GET['idde']) && is_execution_has_donnee_matroulant(htmlspecialchars($_GET['idde'])) == true) {
					    				
						
          ?>
		    
		  &nbsp;<a href="liste_matroulant_execution.php?idp=<?php echo $projet['id_projet'].'&idde='.$idde; ?>"><button style="margin-top: 20px;" class="btn btn-primary btn-mini" type="button">Liste materiel roulant execution <i class="icon icon-arrow-right icon-white"></i>  </button></a>
