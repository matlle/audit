	...
	if (isset($_POST['submit'])) {
        ...
        if(empty($matricule) || empty($fonction) || empty($salaire) || empty($nombre_h)) 
		     ...
		     $error = "Veuillez saisir des nombres pour le salaire et le nombre horaire.";
			    ...
			    editPersonnelPrevision($matricule, $fonction, $salaire, $nombre_h, $iddp, $idperso, $cid);

		         $_SESSION['edited_person_prevision'] = 'Personnel modifié!';
...
?>
    ...
    <center>
	     ...
	     <?php
                    if(isset($_GET['idp']) && !empty($_GET['idp']) && is_projet_exist(htmlspecialchars($_GET['idp'])) == true && isset($_GET['idperso']) && !empty($_GET['idperso'])   && isset($_GET['iddp']) && !empty($_GET['iddp'])) {
          ...
          ?>
			  ...
			  <h4>Modification du personnelle <span style="color: #08c;"><?php echo $personnel['matricule_personnel_previsionnelle']; ?></span></h4>
  ...
  <center>
      ...
      <div class="" style="background-color:#6DCCF4; margin-top: 20px; width: 600px; border: 2px solid black; border-radius: 4px;">
          ...
          <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'].'?iddp='.$iddp.'&idp='.$idp.'&idperso='.$idperso; ?>" method="post" enctype="multipart/form-data" id="" style="padding-top: 50px;">
		                                
              <div class="control-group">
			  
               <label class="control-label">Matricule Personnel:</label>
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="matricule_personnel" id="matricule_personnel" value="<?php if($matricule) echo $matricule; else echo $personnel['matricule_personnel_previsionnelle']; ?>" placeholder="Entrez le matricule  du personnel">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="fonction_personnel" id="fonction_personnel" value="<?php if($fonction) echo $fonction; else echo $personnel['fonction_personnel_previsionnelle']; ?>" placeholder="Entrez la fonction du personnel">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="salaire_personnel" id="salaire_personnel" value="<?php if($salaire) echo $salaire; else echo $personnel['salaire_horaire_personnel_previsionnelle']; ?>" placeholder="Entrez le salaire du personnel">
			  ...
			  <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="horaire_personnel" id="horaire_personnel" value="<?php if($nombre_h) echo $nombre_h; else echo $personnel['nombre_horaire_personnel_previsionnelle']; ?>" placeholder="Entrez le nombre d'horaire du personnel">
			...
			<span id="champ_cacheee">
			 ...
			 <a href="liste_personnelle_prevision.php?idp=<?php echo $idp.'&iddp='.$iddp; ?>">
