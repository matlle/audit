...
?>
		...
		<h2 style="background-color: #b5ecb5;; width: 40%;">Detail autres frais</h2>
    ...
    <table border="2 solid #ccc" class="tbliste table table-striped">
	    ...
	    <tr>
	        <th style="color: white; background-color: #555555;">Id autres frais</th>
	        <th style="color: white; background-color: #555555;">Objet</th>		
        ...
        <tr>
	        <td>
			       <?php
					     ...
					     echo $a['id_autresfrais_execution'];
	        ...
	        <td>
			    <?php 
				     echo $a['objet_autresfrais_execution'];
			    ?>
		    </td>
	        <td>
			       <?php 
                        echo $a['unite_autresfrais_execution'];				   
			       ?>
		    </td>		
			<td>
			     <?php
				      $q = $a['quantite_autresfrais_execution'];
					  $tq += $q;
	        ...
	        <td>
			    <?php
				    $c = $a['prix_autresfrais_execution'];
					$tc += $c;
