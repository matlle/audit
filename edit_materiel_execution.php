	...
	if (isset($_POST['submit'])) {
        ...
        if(empty($code) || empty($nom) || empty($unite) || empty($quantite) || empty($cout)) 
		     ...
		     $error = "Veuillez saisir des nombres pour la quantite et le prix.";
			     ...
			     editMaterielExecution($code, $nom, $unite, $quantite, $cout, $idde, $idmateriel, $cid);
				 
		 
		         $_SESSION['edited_materiel_execution'] = 'Materiel chantier modifié!';
...
?>
    ...
    <center>
	     ...
	     <?php
                    if(isset($_GET['idp']) && !empty($_GET['idp']) && is_projet_exist(htmlspecialchars($_GET['idp'])) == true && isset($_GET['idde']) && !empty($_GET['idde']) && isset($_GET['idmateriel']) && !empty($_GET['idmateriel'])) {
          ...
          ?>
			  ...
			  <h4>Modification du materiel de chantier <span style="color: #08c;"><?php echo $materiel['nom_materiel_execution']; ?></span></h4>
  ...
  <center>
      ...
      <div class="" style="background-color:#6DCCF4; margin-top: 20px; width: 600px; border: 2px solid black; border-radius: 4px;">
          ...
          <form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'].'?idp='.$id.'&idde='.$idde.'&idmateriel='.$idmateriel; ?>" method="post" enctype="multipart/form-data" id="" style="padding-top: 50px;">
		                                
              <div class="control-group">
			  
               <label class="control-label">Code materiel chantier:</label>
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="code_materiel" id="code_materiel" value="<?php if($code) echo $code; else echo $materiel['code_materiel_execution']; ?>" placeholder="Entrez le code du matériel chantier">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="nom_materiel" id="nom_materiel" value="<?php if($nom) echo $nom;  else echo $materiel['nom_materiel_execution'];  ?>" placeholder="Entrez le nom materiel">
		 ...
		 <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="unite_materiel" id="unite_materiel" value="<?php if($unite) echo $unite; else echo $materiel['unite_materiel_execution'];  ?>" placeholder="Entrez l'unité du matériel">
			  ...
			  <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="quantite_materiel" id="quantite_materiel" value="<?php if($quantite) echo $quantite;  else echo $materiel['quantite_materiel_execution'];  ?>" placeholder="Entrez la quantité du matériel">
			  ...
			  <div class="control-group">
               ...
               <div class="controls" style="margin-right: 150px;">
                   <input type="text" name="cout_materiel" id="cout_materiel" value="<?php if($cout) echo $cout;  else echo $materiel['cout_materiel_execution'];  ?>" placeholder="Entrez le coût  du matériel">
             ...
             <span id="champ_cacheee">
			      ...
			      <a href="liste_materiel_execution.php?idp=<?php echo $id.'&idde='.$idde; ?>">
	  ...
	  <?php 
		...
		<p>
		  ...
		  &nbsp;<a href="liste_materiel_execution.php?idp=<?php echo $projet['id_projet'].'&idde='.$idde; ?>"><button style="margin-top: 20px;" class="btn btn-primary btn-mini" type="button">Liste materiel execution <i class="icon icon-arrow-right icon-white"></i>  </button></a>
