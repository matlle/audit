...
<div class="col-md-12">
    	...
    	<table class="table table-bordered table-hover table-striped">
                ...
                <tbody class="tbody">
					...
					?>
                      ...
                      <td><div class="text-center">
                                              <?php 
                                                  $date = date_create($history[$i]['log_user_time']);
                                                 echo date_format($date, 'j F Y H:i:s'); 
                                              ?>
                     </div></td>
                            <td><div class="text-center"><?php 
                                                               
                                                               $clogin = getUserById($history[$i]['log_user_current_user_id']);    
                                                               echo $clogin['login']; 
                                                         ?>
                            </div></td>
                            <td><div class="text-center"><?php echo $history[$i]['log_user_msg']; ?></div></td>
			 ...
			 <?php
                  ...
                  echo '<center><h4>Accun changement effectué sur <span style="color: #08c;">'.$info.'</span></h3></center>'; 
              } 
         } else {
						   echo "<center><span style='color: red;'>Error: Aucun utilisateur selectionné</span></center>";
              }						  
			 ?>
				          
		<center>
		<p>
		    &nbsp; <a href="manage_user.php"><button style="margin-top: 20px;" class="btn btn-mini btn-primary" type="button"><i class="icon icon-arrow-left icon-white"></i>  Retour</button></a>
