...
<script type="text/javascript">
   function masquer() {
      document.getElementById("cacher" ).style.visibility = "hidden"; //"visible" pour le réafficher
   }
</script>
...
<script type="text/javascript">
   function masquer2() {
      document.getElementById("cacher2" ).style.visibility = "hidden"; //"visible" pour le réafficher
   }
</script>
