...
?>
    ...
    <center>
	     ...
	     <p>
		    <span id="champ_cacheee"><a href="donnee_previ.php?idp=<?php echo $projet['id_projet']; ?>"><button style="margin-top: 20px;" class="btn btn-info btn-small" type="button" >Saisie données previsionnelles  <i class="icon icon-pencil"></i></button></a></span>
		     &nbsp; &nbsp; &nbsp; &nbsp;
		     <span id="champ_cachee"><a href="donnee_exec.php?idp=<?php echo $projet['id_projet']; ?>"><button style="margin-top: 20px;" class="btn btn-small btn-info" type="button" >Saisie données d'éxecution  <i class="icon icon-pencil"></i></button></a></span>
         </p>
